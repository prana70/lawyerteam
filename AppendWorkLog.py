...
df1=pd.read_excel(os.getcwd()+'\\data\\法律日志报表20191101-20191130.xls') 
df1.rename(columns={'填报人':'提交人','填报时间':'提交时间','备注：':'备注'},inplace=True)
df1.drop(['工号','图片地址','地址','评论信息'],axis=1,inplace=True)
...
os.rename(os.getcwd()+'\\data\\数据导出.xlsx',os.getcwd()+'\\data\\数据导出_备份20191130.xlsx')
